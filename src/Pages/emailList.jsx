...
const EmailList = () => {
  ...
  return (
    ...
    {
      isLoading?<span className="text-white">Loading...</span>:(<section className="right-side w-[300px] border  border-[#23272C] border-r-1 pr-3 pl-3 h-[657px] overflow-y-auto scrollbar-w-0 scrollbar-thumb-[black] ">
